...
grid = RectilinearGrid(GPU(), size = (Nx, Ny, Nz), x = (0, Lx), y = (0, Ly), z = (-Lz, 0), topology = (Periodic, Periodic, Bounded))
...
filename = "Project9/raw-output/BI_xz" * label
...
filename = "Project9/raw-output/BI_xy" * label
...
filename = "Project9/raw-output/BI_yz" * label
...
filename = "Project9/raw-output/BI_ℬ" * label
