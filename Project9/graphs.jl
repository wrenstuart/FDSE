...
function ℬ_timeseries(label)
    filename_ℬ = "Project9/raw-output/BI_ℬ" * label
...
for i₁ = 1 : length(log_Ri)
    for i₂ = 1: length(log_α)
        ...
        display(plt)
        savefig("Project9/graphs/snapshot" * label * ".png")
...
display(plt)
savefig("Project9/graphs/ζ_Ri.png")
...
display(plt)
savefig("Project9/graphs/δ_Ri.png")
